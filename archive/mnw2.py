...
def topology(mobility):
    ...
    net.addLink(sta1, cls=mesh, ssid='meshNet',
                intf='sta1-wlan0', channel=5, ht_cap='HT40+', proto="batmand")  #, passwd='thisisreallysecret')
    net.addLink(sta2, cls=mesh, ssid='meshNet',
                intf='sta2-wlan0', channel=5, ht_cap='HT40+', proto="batmand")  #, passwd='thisisreallysecret')
    net.addLink(sta3, cls=mesh, ssid='meshNet',
                intf='sta3-wlan0', channel=5, ht_cap='HT40+', proto="batmand")  #, passwd='thisisreallysecret')
    net.addLink(sta4, cls=mesh, ssid='meshNet',
        intf='sta4-wlan0', channel=5, ht_cap='HT40+', proto="batmand")  #, passwd='thisisreallysecret')
    net.addLink(sta5, cls=mesh, ssid='meshNet',
        intf='sta5-wlan0', channel=5, ht_cap='HT40+', proto="batmand")  #, passwd='thisisreallysecret')
    net.addLink(sta6, cls=mesh, ssid='meshNet',
            intf='sta6-wlan0', channel=5, ht_cap='HT40+', proto="batmand")  #, passwd='thisisreallysecret')
